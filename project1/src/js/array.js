...
// cars.toSpliced(); // Не мутирует массив
...
// arrs.flat(infinity); // Преобразует в плоский моссив любово уровня вложенности
...
// cars.toSorted(); // Не мутирует массив
// cars.reverse(); // Меняет порядок элементов
// cars.toReversed(); // Не мутирует массив
...
// let arr6 = Array.from(arrayLike); // создаёт новый массив и копирует туда все элементы.
